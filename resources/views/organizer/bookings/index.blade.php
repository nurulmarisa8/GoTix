...
@section('title', 'My Event Bookings - Organizer')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">My Event Bookings</h1>
        <p class="mt-2 text-gray-600">Manage bookings for your events</p>
    </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            @if($booking->status === 'pending')
                                ...
                                <form action="{{ route('bookings.reject', $booking) }}" method="POST" class="inline ml-2">
                                    @csrf
