...
class BookingController extends Controller {
    ...
    public function approveBooking(Booking $booking) {
        // Check if the authenticated user can approve this booking (must be the organizer of the event)
    ...
    public function rejectBooking(Booking $booking) {
        // Check if the authenticated user can reject this booking (must be the organizer of the event)
        $this->authorize('update', $booking->ticket->event);
