...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:organizer'])->prefix('organizer')->group(function () {
        ...
        Route::post('/bookings/{id}/reject', [OrganizerController::class, 'rejectBooking'])->name('organizer.bookings.reject'); // <--- BARU
    ...
    Route::middleware(['role:user'])->group(function () {
        ...
        Route::put('/bookings/{id}/cancel', [BookingController::class, 'cancel'])->name('booking.cancel'); // <--- BARU
    });
